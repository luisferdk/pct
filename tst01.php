...
<script src="/js/jquery.fancybox.js" type="text/javascript"></script> <!-- used for galleries -->
<script src="/js/jquery.raty.min.js" type="text/javascript"></script> <!-- star rating for review -->
<script src="/js/jquery.dataTables.min.js" type="text/javascript"></script> <!-- needed for pagination -->
