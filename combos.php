...
JOIN tour_cat_prod AS r
  ON r.pd_id = t.t_id
  WHERE cat_id = $cat_id AND t_status <> 0
...
<div class="row">
  ...
  <div class="span4">      
    ...
    <span class="span4"><a class="btn btn-warning pull-right" href="/<?php echo $tour_url; ?>/">Learn more <i class="icon-chevron-right icon-white"></i></a></span>
  </div>
</div>
</td></tr>
