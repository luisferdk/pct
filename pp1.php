...
$sql = "select sales_excursions.st_id, sales_excursions.date, sales_transactions.cust_http 
from sales_excursions left join sales_transactions on 
sales_excursions.st_id = sales_transactions.st_id where sales_excursions.date > '2013-12-31' and sales_excursions.date < '2015-01-01'";
...
echo '<br><br>Mobile: '.$cnts;
echo '<br><br>NO Mobile: '.$cnt;
echo '<br><br>total: '.($cnts + $cnt);
?>
