...
//      'AMT'=>$this->cleanAmt($amount, $wholeAmt),
  ...
  /**
   * @uses      Sets the RETURN URL.
   * @access    Public
   * @param     String $full url
   * @return    None.
   * @example   $PayFlow->setReturnURL('http://site.com/ok.php');
   */
  public function setReturnURL($url = '') {
    ...
    $this->NVP = array_merge($this->NVP, $url);
  }
  /**
   * @uses      Sets the CANCEL URL.
   * @access    Public
   * @param     String $full url
   * @return    None.
   * @example   $PayFlow->setCancelURL('http://site.com/cancel.php');
   */
   ...
   * @param     String $token
   * @return    None.
   * @example   $PayFlow->setToken($token);
   */
  public function setToken($token = '') {
    $token = array(
      'TOKEN'=>$token,
    );
    $this->NVP = array_merge($this->NVP, $token);
  }
  ...
  public function setPayerID($id = '') {
    ...
    $this->NVP = array_merge($this->NVP, $id);
  }
